...
class Daemon:
    def __init__(self, cfg: Config):
        ...
        # Discovered-but-unconfigured devices: id -> {name, protocol, rssi, ts}.
    ...
    def _snapshot(self) -> dict:
        ...
        return {"devices": fresh, "discovered": seen}
    ...
    async def push_loop(self) -> None:
        while True:
            ...
            # user turns the feature on in the first place.
    ...
    def record(self, device_id: str, protocol: str, name: str,
               ...
               rssi: int | None = None, extra: dict | None = None) -> None:
            ...
            if protocol == decoders.PROTOCOL_COMBUSTION:
                ...
                if dev_id in self.devices:
                    ...
                    self.discovered[dev_id] = {
                        ...
                        "name": adv.local_name or f"Combustion probe {decoded['probe_id']}",
                        "rssi": adv.rssi, "ts": time.time(),
                    }
                return
